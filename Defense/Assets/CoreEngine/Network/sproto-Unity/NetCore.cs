...
//    public delegate void SocketTimeout();
...
//        public static bool Connect(string host, int port, SocketConnected socketConnected)
//        {
//            Disconnect();
...
//                    {
//                        SprotoTypeBase rpcRsp = rpcReqHandler(protocol.GenRequest(tag, data, offset), tag);
//                        if (pkg.HasSession)
//                        {
